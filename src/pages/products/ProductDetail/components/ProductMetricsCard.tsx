    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
      <div className="p-4 bg-surface rounded-xl border border-border shadow-xs flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-lg font-bold text-ink">{totalBatches} <span className="text-xs font-normal text-ink-muted">lô</span></p>
        </div>
      </div>
      ...
      <div className="p-4 bg-surface rounded-xl border border-border shadow-xs flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-lg font-bold text-ink">{passRate}% <span className="text-xs font-normal text-ink-muted">({totalTestResults} phiếu)</span></p>
        </div>
      </div>
      ...
      <div className="p-4 bg-surface rounded-xl border border-border shadow-xs flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-base font-bold text-ink truncate max-w-[140px]" title={activeTccsCode}>{activeTccsCode}</p>
        </div>
      </div>
      ...
      <div className="p-4 bg-surface rounded-xl border border-border shadow-xs flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-base font-bold text-ink">{lastTestDate ? formatDateStandard(lastTestDate) : 'Chưa có'}</p>
        </div>
      </div>
    </div>
  );
