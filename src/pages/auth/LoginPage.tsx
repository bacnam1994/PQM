      ...
      <div className="w-full max-w-sm relative z-10 animate-in fade-in duration-200">
        <div className="bg-surface rounded-2xl shadow-xs border border-border p-6 sm:p-8">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-xl font-bold text-ink tracking-tight text-center">V-BIOTECH QMS</h1>
            <p className="text-ink-muted text-xs font-medium mt-1">Hệ thống Quản lý Chất lượng Dược phẩm</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-medium text-ink-muted pl-1">Tài khoản Email</label>
              ...
              <div className="text-right pr-1 pt-0.5">
                <Link to="/forgot-password" className="text-xs font-medium text-emerald-600 dark:text-emerald-400 hover:underline">Quên mật khẩu?</Link>
              </div>
            </div>
          ...
          <div className="mt-6 pt-4 border-t border-border text-center">
            <p className="text-xs text-ink-muted font-normal">
              Chưa có tài khoản?{' '}
              <Link to="/signup" className="font-medium text-emerald-600 dark:text-emerald-400 hover:underline">Đăng ký ngay</Link>
            </p>
          </div>
        </div>
      </div>
