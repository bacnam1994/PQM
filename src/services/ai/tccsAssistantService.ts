...
export const PHARMACOPOEIA_TEMPLATES: Record<DosageFormType, DosageFormTemplate> = {
    ...
    criteria: [
      {
        ...
        expectedText: 'Viên nén nguyên vẹn, bề mặt nhẵn, màu sắc đồng nhất',
        category: 'main',
      },
      {
        name: 'Độ đồng đều khối lượng',
        type: CriterionType.TEXT,
        expectedText: 'Đạt yêu cầu phép thử độ đồng đều khối lượng',
        category: 'main',
      },
      {
        name: 'Độ rã',
        ...
        unit: 'phút',
        category: 'main',
        notes: '≤ 15 phút (viên không bao) hoặc ≤ 30 phút (viên bao phim)',
      },
      {
        name: 'Độ hòa tan',
        type: CriterionType.NUMBER,
        ...
        unit: '%',
        category: 'main',
        notes: 'Q ≥ 70-75% sau 30-45 phút',
      },
      {
        name: 'Độ ẩm / Mất khối lượng do làm khô',
        type: CriterionType.NUMBER,
        max: 5.0,
        unit: '%',
        category: 'main',
      ...
      {
        name: 'Tổng số vi sinh vật hiếu khí (TAMC)',
        type: CriterionType.NUMBER,
        max: 1000,
        unit: 'CFU/g',
        category: 'micro',
      ...
      {
        name: 'Tổng số nấm men, nấm mốc (TYMC)',
        type: CriterionType.NUMBER,
        max: 100,
        unit: 'CFU/g',
        category: 'micro',
    ...
    criteria: [
      {
        name: 'Cảm quan',
        type: CriterionType.TEXT,
        expectedText: 'Viên nang nguyên vẹn, không biến dạng, bột/dịch bên trong đồng nhất',
        category: 'main',
      },
      {
        name: 'Độ đồng đều khối lượng',
        type: CriterionType.TEXT,
        expectedText: 'Đạt yêu cầu phép thử độ đồng đều khối lượng viên nang',
        category: 'main',
      },
      {
        name: 'Độ rã',
    ...
    criteria: [
      {
        name: 'Cảm quan',
        type: CriterionType.TEXT,
        expectedText: 'Chất lỏng trong suốt hoặc hỗn dịch đồng nhất, mùi thơm đặc trưng, vị ngọt',
        category: 'main',
      },
      ...
      { name: 'Tỷ trọng', type: CriterionType.NUMBER, min: 1.15, max: 1.35, category: 'main' },
      {
        name: 'Thể tích thực',
        type: CriterionType.TEXT,
        expectedText: 'Không được dưới thể tích ghi trên nhãn',
        category: 'main',
      },
      {
        name: 'Tổng số vi sinh vật hiếu khí (TAMC)',
      ...
      },
      {
        name: 'Escherichia coli',
        type: CriterionType.TEXT,
        expectedText: 'Không được có / 1ml',
        category: 'micro',
      },
    ],
  },
    ...
    criteria: [
      {
        name: 'Cảm quan',
        type: CriterionType.TEXT,
        expectedText: 'Bột/cốm khô tơi, đồng nhất về màu sắc, không vón cục',
        category: 'main',
      },
      {
        name: 'Mất khối lượng do làm khô (Độ ẩm)',
        type: CriterionType.NUMBER,
        max: 5.0,
        unit: '%',
        category: 'main',
      },
      {
        name: 'Độ đồng đều khối lượng',
        type: CriterionType.TEXT,
        expectedText: 'Đạt yêu cầu độ đồng đều khối lượng gói',
        category: 'main',
      },
      {
        name: 'Độ hòa tan / Phân tán',
        type: CriterionType.TEXT,
        expectedText: 'Hòa tan hoặc phân tán hoàn toàn trong nước',
        category: 'main',
      },
      {
        name: 'Tổng số vi sinh vật hiếu khí (TAMC)',
  ...
  INJECTION: {
    ...
    criteria: [
      {
        name: 'Cảm quan & Độ trong',
        type: CriterionType.TEXT,
        expectedText: 'Dung dịch trong suốt, không có tiểu phân lạ nhìn thấy bằng mắt thường',
        category: 'main',
      },
      { name: 'pH', type: CriterionType.NUMBER, min: 6.0, max: 8.0, category: 'main' },
      {
        name: 'Thể tích có thể lấy ra',
        type: CriterionType.TEXT,
        expectedText: 'Đạt theo chuyên luận thể tích thuốc tiêm',
        category: 'main',
      },
      {
        name: 'Nội độc tố vi khuẩn (Bacterial Endotoxin)',
        type: CriterionType.NUMBER,
        max: 0.25,
        unit: 'EU/ml',
        category: 'main',
      ...
      {
        name: 'Độ vô khuẩn (Sterility Test)',
        type: CriterionType.TEXT,
        expectedText: 'Vô khuẩn (Không phát hiện vi sinh vật)',
        category: 'micro',
      },
    ],
  },
    ...
    criteria: [
      {
        name: 'Cảm quan',
        type: CriterionType.TEXT,
        expectedText: 'Chế phẩm mềm mịn, đồng nhất, không tách pha hay biến màu',
        category: 'main',
      },
      {
        name: 'Độ đồng đều khối lượng',
        type: CriterionType.TEXT,
        expectedText: 'Đạt yêu cầu khối lượng tuýp/lọ',
        category: 'main',
      },
      ...
      {
        name: 'Pseudomonas aeruginosa & S. aureus',
        type: CriterionType.TEXT,
        expectedText: 'Không được có / 1g',
        category: 'micro',
      },
...
export const generateCriteriaFromFormula = (
  ...
  ingredients.forEach((ing) => {
    ...
    // Tự động phát hiện nếu có khai báo hàm lượng nguyên tố cốt lõi (dạng muối)
    const hasElemental =
      ing.elementalContent !== undefined &&
      ing.elementalContent !== null &&
      Number(ing.elementalContent) > 0;
    const baseContent = hasElemental
      ? Number(ing.elementalContent)
      : Number(ing.declaredContent) || 0;
    const basisType: 'ELEMENTAL' | 'DECLARED' = hasElemental ? 'ELEMENTAL' : 'DECLARED';
    ...
    result.push({
      ...
      max: maxVal,
      declaredContent:
        ing.declaredContent != null && Number(ing.declaredContent) > 0
          ? Number(ing.declaredContent)
          : baseContent > 0
            ? baseContent
            : undefined,
      formulaIngredientId: ing.name, // Hard-link với thành phần công thức
      calculationBasis: basisType,
      notes: hasElemental
        ? `Hàm lượng nguyên tố: ${baseContent} ${unit} (±${tolerancePercentage}%) - Cơ sở Ion/Base`
        : baseContent > 0
          ? `Hàm lượng danh định: ${baseContent} ${unit} (±${tolerancePercentage}%)`
          : 'Theo công thức',
    });
  });
...
export const checkTCCSFormulaConflicts = (
  ...
  activeIngredients.forEach((ing) => {
    ...
    const hasMatch = tccsNames.some(
      (name) => name.includes(ingNameLower) || ingNameLower.includes(name)
    );
    if (!hasMatch) {
      warnings.push(
        `Hoạt chất "${ing.name}" trong công thức chưa có chỉ tiêu định lượng tương ứng trong TCCS.`
      );
    }
  });
