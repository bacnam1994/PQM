import {
  generateQualityReport as _generateReport,
  detectQualityAnomalies as _detectAnomalies,
 ...
 */
export const generateQualityReport = async (args: any, appContext: any) => {
  ...
  try {
    const result = await _generateReport(appContext, opts);
    return {
      success: true,
